...
function toneFromVerdict(verdict: string): { color: string; bg: string; border: string } {
  ...
  if (normalized === "malicious") return { color: "var(--red)", bg: "rgba(240,112,80,0.10)", border: "rgba(240,112,80,0.28)" };
  if (normalized === "suspicious") return { color: "var(--yellow)", bg: "rgba(240,160,80,0.10)", border: "rgba(240,160,80,0.28)" };
  if (normalized === "benign") return { color: "var(--green)", bg: "rgba(46,204,113,0.10)", border: "rgba(46,204,113,0.28)" };
  return { color: "var(--accent)", bg: "rgba(79,110,247,0.08)", border: "rgba(79,110,247,0.24)" };
}
        ...
        {TAB_LABELS.map((tab) => (
          <button
            ...
            style={{
              ...
              background: active === tab.id ? "rgba(79,110,247,0.14)" : "transparent",
              borderColor: active === tab.id ? "rgba(79,110,247,0.38)" : "transparent",
            }}
          >
            {tab.label}
          </button>
      ...
      <div style={segmentedStyle}>
        <button
          ...
          style={{
            ...
            background: audience === "analyst" ? "rgba(79,110,247,0.14)" : "transparent",
            borderColor: audience === "analyst" ? "rgba(79,110,247,0.38)" : "transparent",
          }}
        >
          Analyst Report
        </button>
        <button
          ...
          style={{
            ...
            background: audience === "executive" ? "rgba(79,110,247,0.14)" : "transparent",
            borderColor: audience === "executive" ? "rgba(79,110,247,0.38)" : "transparent",
          }}
        >
          Executive Brief
        </button>
...
function nodeColor(node: any) {
  ...
  if (type.includes("opencti") || type.includes("attack") || type.includes("malware")) return "#4f6ef7";
...
const timelineDotStyle: React.CSSProperties = {
  ...
  height: 11,
  borderRadius: "50%",
  boxShadow: "0 0 0 5px rgba(79,110,247,0.12)",
};
