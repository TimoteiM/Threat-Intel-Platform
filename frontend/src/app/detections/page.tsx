        ...
        return (
          <button
            ...
            style={{
              ...
              background: active ? "rgba(79, 110, 247, 0.12)" : "var(--panel-card-bg)",
              color: "var(--text)",
  ...
  const chip = (
    ...
    <span
      ...
      style={{
        ...
        padding: "3px 8px",
        borderRadius: 6,
        border: `1px solid ${tone === "claim" ? "var(--panel-divider-strong)" : "rgba(46, 204, 113, 0.35)"}`,
        background: tone === "claim" ? "var(--bg-elevated)" : "rgba(46, 204, 113, 0.08)",
        color: "var(--text)",
        fontSize: "var(--font-micro)",
        ...MONO,
      }}
