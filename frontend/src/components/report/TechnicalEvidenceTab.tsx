...
function CollectorRerunButton({ investigationId, collector, onRefresh, label }: {
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
      ...
      {done && !running && <span style={{ fontSize: 10, color: "#2ecc71" }}>Updated</span>}
      {error && <span style={{ fontSize: 10, color: "#f07050" }}>{error}</span>}
    </span>
  );
}
              ...
              <>
                ...
                {dkimCount === 0 && (
                  <div style={{
                    ...
                    background: "rgba(240,160,80,0.06)", borderRadius: "var(--radius-sm)",
            ...
            return (
              <>
                ...
                <div style={{
                  ...
                  background: cloaking ? "rgba(240,112,80,0.06)" : "rgba(46,204,113,0.06)",
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {arr(http.brand_indicators).map((phrase: string, i: number) => (
                  <span key={i} style={{
                    ...
                    background: "rgba(240,160,80,0.10)", color: "var(--yellow)",
                    borderRadius: "var(--radius-sm)", border: "1px solid rgba(240,160,80,0.2)",
                    fontFamily: "var(--font-mono)",
                  }}>
                    {phrase}
                  </span>
                          ...
                          <div style={{ display: "flex", flexDirection: "column", gap: 2, maxHeight: 400, overflowY: "auto" }}>
                            {arr(ja.captured_requests).map((req: any, i: number) => (
                              <div key={i} style={{
                                ...
                                background: req.is_external ? "rgba(240,160,80,0.04)" : "rgba(46,204,113,0.04)",
                                ...
                                <span style={{
                                  ...
                                  background: req.method === "POST" ? "rgba(240,112,80,0.15)" : "rgba(79,110,247,0.12)",
                            ...
                            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                              {arr(ja.request_domains).map((domain: string, i: number) => {
                                ...
                                return (
                                  <span key={i} style={{
                                    padding: "4px 10px", fontSize: 11, fontWeight: 500,
                                    background: isExt ? "rgba(240,160,80,0.10)" : "rgba(46,204,113,0.10)",
                                    color: isExt ? "var(--yellow)" : "var(--green)",
                                    borderRadius: "var(--radius-sm)",
                                    border: `1px solid ${isExt ? "rgba(240,160,80,0.2)" : "rgba(46,204,113,0.2)"}`,
                                    fontFamily: "var(--font-mono)",
                                  }}>
                                    {domain}
                                  </span>
                        ...
                        {arr(ja.post_endpoints).length > 0 ? (
                          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                            {arr(ja.post_endpoints).map((p: any, i: number) => (
                              <div key={i} style={{
                                padding: "8px 12px",
                                background: p.is_credential_form ? "rgba(240,112,80,0.06)" : "rgba(79,110,247,0.04)",
                                ...
                                <span style={{ display: "flex", gap: 4, flexShrink: 0 }}>
                                  {p.is_external && (
                                    <span style={{
                                      ...
                                      background: "rgba(240,160,80,0.15)", color: "var(--yellow)", borderRadius: 3,
                                    }}>EXTERNAL</span>
                                  )}
                                  {p.is_credential_form && (
                                    <span style={{
                                      padding: "2px 6px", fontSize: 9, fontWeight: 600,
                                      background: "rgba(240,112,80,0.15)", color: "var(--red)", borderRadius: 3,
                                    }}>CREDENTIAL</span>
                                  )}
                                </span>
                              </div>
                            ...
                            {arr(ja.request_domains).map((domain: string, i: number) => {
                              ...
                              return (
                                <div key={i} style={{
                                  ...
                                  background: isExt ? "rgba(240,160,80,0.04)" : "rgba(46,204,113,0.04)",
                                  ...
                                  <span style={{
                                    padding: "1px 5px", fontSize: 9, fontWeight: 600,
                                    background: isExt ? "rgba(240,160,80,0.12)" : "rgba(46,204,113,0.12)",
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {arr(vt.flagged_malicious_by).map((vendor: string, i: number) => (
                    <span key={i} style={{
                      padding: "4px 10px", fontSize: 11, fontWeight: 500,
                      background: "rgba(240,112,80,0.10)", color: "var(--red)",
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          border: "1px solid rgba(79,110,247,.38)", borderRadius: 13,
      ...
      >
        <span aria-hidden="true" style={{ width: 30, height: 30, display: "grid", placeContent: "center", borderRadius: 9, background: "rgba(79,110,247,.12)", color: "var(--accent)", fontSize: 15 }}>☷</span>
      ...
      {open && (
        <div role="menu" aria-label="Technical Evidence sections" style={{
          ...
          border: "1px solid rgba(79,110,247,.3)", borderRadius: 13,
          ...
          {sections.map((section) => (
            <button
              ...
              style={{
                ...
                padding: "8px 9px", border: active === section.title ? "1px solid rgba(79,110,247,.34)" : "1px solid transparent",
                borderRadius: 8, background: active === section.title ? "rgba(79,110,247,.12)" : "transparent",
      ...
      >
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", marginBottom: 10 }}>
            ...
            <OpenCtiPill label={String(openCti?.observable_entity_type || "Unknown").toUpperCase()} color="#a9b9ff" />
          </div>
...
function OpenCtiSignalStrip({ openCti }: { openCti: any }) {
  ...
  const signals = [
    ...
    { label: "Reports", value: arr(openCti?.reports).length, color: "#4f6ef7" },
    { label: "Actors", value: arr(openCti?.threat_actors).length, color: "#f472b6" },
    { label: "Malware", value: arr(openCti?.malware_families).length, color: "#f07050" },
    { label: "ATT&CK", value: arr(openCti?.attack_patterns).length, color: "#4f6ef7" },
    { label: "Campaigns", value: arr(openCti?.campaigns).length + arr(openCti?.intrusion_sets).length, color: "#2ecc71" },
  ];
