        ...
        return (
          <button
            ...
            style={{
              ...
              background: active ? "rgba(139, 123, 255, 0.12)" : "var(--panel-card-bg)",
              color: "var(--text)",
  ...
  const chip = (
    ...
    <span
      ...
      style={{
        ...
        padding: "3px 8px",
        borderRadius: 6,
        border: `1px solid ${tone === "claim" ? "var(--panel-divider-strong)" : "rgba(43, 212, 160, 0.35)"}`,
        background: tone === "claim" ? "var(--bg-elevated)" : "rgba(43, 212, 160, 0.08)",
        color: "var(--text)",
        fontSize: "var(--font-micro)",
        ...MONO,
      }}
