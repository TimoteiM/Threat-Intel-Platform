...
export default function InfrastructureTab({ investigationId, evidence }: Props) {
  ...
  if (error) {
    return (
      <div style={{
        padding: 20, background: "rgba(240,112,80,0.06)",
                  ...
                  {hasMore && (
                    <button
                      ...
                      style={{
                        ...
                        border: "1px solid rgba(79,110,247,0.25)", borderRadius: "var(--radius-sm)",
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {cluster.domains.map((d, j) => (
                  <span key={j} style={{
                    padding: "3px 10px", fontSize: 11,
                    background: "rgba(79,110,247,0.08)", color: "var(--accent)",
                    borderRadius: "var(--radius-sm)", border: "1px solid rgba(79,110,247,0.2)",
                    fontFamily: "var(--font-mono)",
                  }}>{d}</span>
                ))}
              </div>
